...
(function(root){
  ...
  const api={CHANNEL,channelField,baseWaterHeight,currentAlong,currentAcceleration,channelGLSL,waveHeight,spring,createWaterEntry,stepWaterEntry,chooseRoute,rampSample,featureDistance};
  return api;
  }
